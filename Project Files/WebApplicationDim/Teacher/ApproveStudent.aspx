                        ...
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-md-offset-4" style="max-height: 300px; overflow-y: auto">
                                    <asp:CheckBoxList runat="server" CssClass="form-control" Style="max-height: none; height: 100%; max-width: 280px"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-md-offset-4" style="max-height: 300px; overflow-y: auto">
                                    <asp:CheckBoxList runat="server" CssClass="form-control" Style="max-height: none; height: 100%; max-width: 280px" ID="cblApprovedStudent">
                                    </asp:CheckBoxList>
                                </div>
                            </div>
                            <div class="form-group">
