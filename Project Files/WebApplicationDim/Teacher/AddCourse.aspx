<%@ Page Title="Creat a new course" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCourse.aspx.cs" Inherits="WebApplicationDim.Teacher.AddCourse" %>
        ...
        <div class="panel panel-primary col-md-6 col-md-offset-3">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="ddlVersity" CssClass="col-md-4 control-label">Select Versity</asp:Label>
                                <div class="col-md-8">
                            ...
                            <br />
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="ddlDepartment" CssClass="col-md-4 control-label">Select Department</asp:Label>
                                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtPrefix" CssClass="col-md-4 control-label">Prefix</asp:Label>
                        <div class="col-md-8">
                    ...
                    <br />
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtCourseNo" CssClass="col-md-4 control-label">Course No</asp:Label>
                        <div class="col-md-8">
                    ...
                    <br />
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtPostfix" CssClass="col-md-4 control-label">Postfix</asp:Label>
                        <div class="col-md-8">
                            <asp:TextBox ID="txtPostfix" Text="NULL" Style="max-width: 280px" CssClass="form-control" runat="server">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtPostfix" runat="server" ErrorMessage="Field cannot be empty.If there is no postfix type ''NULL''" ControlToValidate="txtPostfix"  CssClass="text-danger"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <br />
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtCourseTitle" CssClass="col-md-4 control-label">Course Title</asp:Label>
                        <div class="col-md-8">
                    ...
                    <br />
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtCredit" CssClass="col-md-4 control-label">Credit</asp:Label>
                        <div class="col-md-8">
