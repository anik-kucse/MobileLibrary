                        ...
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                <div style="width: 100%; height: 100%; overflow: auto">
                                    <asp:GridView runat="server" ID="gvAttendence" AutoGenerateColumns="true" OnRowDataBound="gvAttendence_RowDataBound" Width="100%" GridLines="Horizontal" CellPadding="5">
                                    </asp:GridView>
                                </div>
                            </div>
                        </ContentTemplate>
